...
function stopRotateWheel() {
  var valorApostado = document.getElementById("form").value;
  document.getElementById("form").value = ""; //Limpa o formulario
  ...
  if(numeroSorteado == 0 && corSelecionada == 'Branco'){
    text = 'Voce apostou '+valorApostado+' e ganhou '+10*valorApostado; //Resultado da aposta
  }else if
    ((index %2 != 0 && corSelecionada == 'Vermelho') ||
    (index %2 == 0 && corSelecionada == 'Preto')){
      text = 'Voce apostou '+valorApostado+' e ganhou '+2*valorApostado; //Resultado da aposta
  }else{
