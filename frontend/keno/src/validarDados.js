...
function mudaCordeFundo(numero, gatilho) {
    switch (numero) {
        case 1: 
            ...
            if (gatilho == 0) { container.style.backgroundColor = '#333';
...
function validarDados() {
    recebeValorApostadoJ = document.getElementById("entrada").value;
...
function preencheBolasSort(numSort, numAc) {
    ...
    for(var i = 0; i < vetorDiferenca.length; i++) {
        switch (vetorDiferenca[i]) {
            case 1: 
                var container = document.getElementById("bola1");
                container.style.backgroundColor = '#ac41ba';
                break;
            case 2: 
                var container = document.getElementById("bola2");
                container.style.backgroundColor = '#ac41ba';
...
function calculaValorRodada() {
    var recebeValorApostado = document.getElementById("entrada").value;
...
function calculaValorTotal(valor) {
    var xy = document.getElementById("entrada").value;
...
function preencheInterface() {
    ...
    document.getElementById("retornoFinal1").style.visibility="visible";
    if(w == 0) {
        document.getElementById("RecebeuFinal").innerHTML = 'Zero bolas acertadas';
    } else {
        var valorGanhoAtual = calculaValorTotal(calculaValorRodada());
        
        document.getElementById("RecebeuFinal").innerHTML = 'Retorno: R$'+valorGanhoAtual;
